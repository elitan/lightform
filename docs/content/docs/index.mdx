...
Luma is a TypeScript CLI tool that provides **zero-downtime deployments** and **automatic HTTPS** on your own servers. Deploy any Docker application with blue-green deployments, automatic SSL certificates, health checks, and multi-server support.
...
Get started with Luma in just a few minutes:

<Cards>
  <Card title='Installation' href='/docs/installation' />
  <Card title='Your First Deployment' href='/docs/quick-start' />
...
Ready to deploy? Follow our [Quick Start guide](/docs/quick-start) to deploy your first application with Luma.
