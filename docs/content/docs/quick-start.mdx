...
- [Add a database service](/docs/configuration#services)
- [Deploy to multiple servers](/docs/guides/multi-server)
- [Set up multiple environments](/docs/guides/environments)
- [Configure health checks](/docs/configuration#health-checks)
...
- [Basic Go Application](/docs/examples/basic) - Simple HTTP server
- [Next.js Application](/docs/examples/nextjs) - Full-stack React app
- [Full-Stack with Database](/docs/examples/fullstack) - App + PostgreSQL
